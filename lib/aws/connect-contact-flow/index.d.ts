...
export declare function connectContactFlowTimeoutsToTerraform(struct?: ConnectContactFlowTimeouts | cdktf.IResolvable): any;
export declare function connectContactFlowTimeoutsToHclTerraform(struct?: ConnectContactFlowTimeouts | cdktf.IResolvable): any;
export declare class ConnectContactFlowTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ConnectContactFlowTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: ConnectContactFlowTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
export declare class ConnectContactFlow extends cdktf.TerraformResource {
    ...
    */
    ...
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | ConnectContactFlowTimeouts | undefined;
