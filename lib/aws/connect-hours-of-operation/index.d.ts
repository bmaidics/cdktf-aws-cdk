...
export declare function connectHoursOfOperationTimeoutsToTerraform(struct?: ConnectHoursOfOperationTimeouts | cdktf.IResolvable): any;
export declare function connectHoursOfOperationTimeoutsToHclTerraform(struct?: ConnectHoursOfOperationTimeouts | cdktf.IResolvable): any;
export declare class ConnectHoursOfOperationTimeoutsOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    private resolvableValue?;
    /**
    * @param terraformResource The parent resource
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string);
    get internalValue(): ConnectHoursOfOperationTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: ConnectHoursOfOperationTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
export declare class ConnectHoursOfOperation extends cdktf.TerraformResource {
    ...
    */
    ...
    private _timeouts;
    get timeouts(): ConnectHoursOfOperationTimeoutsOutputReference;
    putTimeouts(value: ConnectHoursOfOperationTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | ConnectHoursOfOperationTimeouts | undefined;
