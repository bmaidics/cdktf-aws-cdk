...
export declare function dbSecurityGroupIngressToTerraform(struct?: DbSecurityGroupIngress | cdktf.IResolvable): any;
export declare function dbSecurityGroupIngressToHclTerraform(struct?: DbSecurityGroupIngress | cdktf.IResolvable): any;
export declare class DbSecurityGroupIngressOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DbSecurityGroupIngress | cdktf.IResolvable | undefined;
    set internalValue(value: DbSecurityGroupIngress | cdktf.IResolvable | undefined);
    private _cidr?;
    get cidr(): string;
    ...
    private _securityGroupOwnerId?;
    get securityGroupOwnerId(): string;
    set securityGroupOwnerId(value: string);
    resetSecurityGroupOwnerId(): void;
    get securityGroupOwnerIdInput(): string | undefined;
}
export declare class DbSecurityGroupIngressList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: DbSecurityGroupIngress[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    get(index: number): DbSecurityGroupIngressOutputReference;
}
/**
...
export declare class DbSecurityGroup extends cdktf.TerraformResource {
    static readonly tfResourceType = "aws_db_security_group";
    /**
    ...
    */
    ...
    private _ingress;
    get ingress(): DbSecurityGroupIngressList;
    putIngress(value: DbSecurityGroupIngress[] | cdktf.IResolvable): void;
    get ingressInput(): cdktf.IResolvable | DbSecurityGroupIngress[] | undefined;
