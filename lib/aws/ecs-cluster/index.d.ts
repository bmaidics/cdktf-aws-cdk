...
export declare function ecsClusterDefaultCapacityProviderStrategyToHclTerraform(struct?: EcsClusterDefaultCapacityProviderStrategy | cdktf.IResolvable): any;
export declare class EcsClusterDefaultCapacityProviderStrategyOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    ...
    */
    ...
    get internalValue(): EcsClusterDefaultCapacityProviderStrategy | cdktf.IResolvable | undefined;
    set internalValue(value: EcsClusterDefaultCapacityProviderStrategy | cdktf.IResolvable | undefined);
    private _base?;
    get base(): number;
...
export declare class EcsClusterDefaultCapacityProviderStrategyList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: EcsClusterDefaultCapacityProviderStrategy[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    get(index: number): EcsClusterDefaultCapacityProviderStrategyOutputReference;
}
...
export declare class EcsCluster extends cdktf.TerraformResource {
    ...
    */
    ...
    get defaultCapacityProviderStrategy(): EcsClusterDefaultCapacityProviderStrategyList;
    putDefaultCapacityProviderStrategy(value: EcsClusterDefaultCapacityProviderStrategy[] | cdktf.IResolvable): void;
