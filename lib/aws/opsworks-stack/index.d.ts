...
export declare function opsworksStackCustomCookbooksSourceToTerraform(struct?: OpsworksStackCustomCookbooksSource | cdktf.IResolvable): any;
export declare function opsworksStackCustomCookbooksSourceToHclTerraform(struct?: OpsworksStackCustomCookbooksSource | cdktf.IResolvable): any;
export declare class OpsworksStackCustomCookbooksSourceOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): OpsworksStackCustomCookbooksSource | cdktf.IResolvable | undefined;
    set internalValue(value: OpsworksStackCustomCookbooksSource | cdktf.IResolvable | undefined);
    private _password?;
    get password(): string;
...
export declare class OpsworksStackCustomCookbooksSourceList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: OpsworksStackCustomCookbooksSource[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    get(index: number): OpsworksStackCustomCookbooksSourceOutputReference;
}
/**
...
export declare class OpsworksStack extends cdktf.TerraformResource {
    ...
    */
    ...
    get customCookbooksSource(): OpsworksStackCustomCookbooksSourceList;
    putCustomCookbooksSource(value: OpsworksStackCustomCookbooksSource[] | cdktf.IResolvable): void;
    resetCustomCookbooksSource(): void;
    get customCookbooksSourceInput(): cdktf.IResolvable | OpsworksStackCustomCookbooksSource[] | undefined;
