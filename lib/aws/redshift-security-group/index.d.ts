...
export declare function redshiftSecurityGroupIngressToHclTerraform(struct?: RedshiftSecurityGroupIngress | cdktf.IResolvable): any;
export declare class RedshiftSecurityGroupIngressOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): RedshiftSecurityGroupIngress | cdktf.IResolvable | undefined;
    set internalValue(value: RedshiftSecurityGroupIngress | cdktf.IResolvable | undefined);
    private _cidr?;
    get cidr(): string;
...
export declare class RedshiftSecurityGroupIngressList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: RedshiftSecurityGroupIngress[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    get(index: number): RedshiftSecurityGroupIngressOutputReference;
}
/**
...
export declare class RedshiftSecurityGroup extends cdktf.TerraformResource {
    ...
    */
    ...
    private _ingress;
    get ingress(): RedshiftSecurityGroupIngressList;
    putIngress(value: RedshiftSecurityGroupIngress[] | cdktf.IResolvable): void;
