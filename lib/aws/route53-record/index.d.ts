...
export declare function route53RecordAliasToHclTerraform(struct?: Route53RecordAlias | cdktf.IResolvable): any;
export declare class Route53RecordAliasOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): Route53RecordAlias | cdktf.IResolvable | undefined;
    set internalValue(value: Route53RecordAlias | cdktf.IResolvable | undefined);
...
export declare class Route53RecordAliasList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: Route53RecordAlias[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    get(index: number): Route53RecordAliasOutputReference;
}
...
export declare function route53RecordFailoverRoutingPolicyToHclTerraform(struct?: Route53RecordFailoverRoutingPolicy | cdktf.IResolvable): any;
export declare class Route53RecordFailoverRoutingPolicyOutputReference extends cdktf.ComplexObject {
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): Route53RecordFailoverRoutingPolicy | cdktf.IResolvable | undefined;
    set internalValue(value: Route53RecordFailoverRoutingPolicy | cdktf.IResolvable | undefined);
    private _type?;
    get type(): string;
    set type(value: string);
    get typeInput(): string | undefined;
}
export declare class Route53RecordFailoverRoutingPolicyList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: Route53RecordFailoverRoutingPolicy[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    * @param wrapsSet whether the list is wrapping a set (will add tolist() to be able to access an item via an index)
    ...
    * @param index the index of the item to return
    */
    get(index: number): Route53RecordFailoverRoutingPolicyOutputReference;
}
...
export declare function route53RecordGeolocationRoutingPolicyToHclTerraform(struct?: Route53RecordGeolocationRoutingPolicy | cdktf.IResolvable): any;
export declare class Route53RecordGeolocationRoutingPolicyOutputReference extends cdktf.ComplexObject {
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): Route53RecordGeolocationRoutingPolicy | cdktf.IResolvable | undefined;
    set internalValue(value: Route53RecordGeolocationRoutingPolicy | cdktf.IResolvable | undefined);
    private _continent?;
...
export declare class Route53RecordGeolocationRoutingPolicyList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: Route53RecordGeolocationRoutingPolicy[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    * @param wrapsSet whether the list is wrapping a set (will add tolist() to be able to access an item via an index)
    ...
    * @param index the index of the item to return
    */
    get(index: number): Route53RecordGeolocationRoutingPolicyOutputReference;
}
...
export declare function route53RecordLatencyRoutingPolicyToHclTerraform(struct?: Route53RecordLatencyRoutingPolicy | cdktf.IResolvable): any;
export declare class Route53RecordLatencyRoutingPolicyOutputReference extends cdktf.ComplexObject {
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): Route53RecordLatencyRoutingPolicy | cdktf.IResolvable | undefined;
    set internalValue(value: Route53RecordLatencyRoutingPolicy | cdktf.IResolvable | undefined);
    private _region?;
    get region(): string;
    set region(value: string);
    get regionInput(): string | undefined;
}
export declare class Route53RecordLatencyRoutingPolicyList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: Route53RecordLatencyRoutingPolicy[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    * @param wrapsSet whether the list is wrapping a set (will add tolist() to be able to access an item via an index)
    ...
    * @param index the index of the item to return
    */
    get(index: number): Route53RecordLatencyRoutingPolicyOutputReference;
}
...
export declare function route53RecordWeightedRoutingPolicyToHclTerraform(struct?: Route53RecordWeightedRoutingPolicy | cdktf.IResolvable): any;
export declare class Route53RecordWeightedRoutingPolicyOutputReference extends cdktf.ComplexObject {
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): Route53RecordWeightedRoutingPolicy | cdktf.IResolvable | undefined;
    set internalValue(value: Route53RecordWeightedRoutingPolicy | cdktf.IResolvable | undefined);
    private _weight?;
    get weight(): number;
    set weight(value: number);
    get weightInput(): number | undefined;
}
export declare class Route53RecordWeightedRoutingPolicyList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: Route53RecordWeightedRoutingPolicy[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    * @param wrapsSet whether the list is wrapping a set (will add tolist() to be able to access an item via an index)
    ...
    * @param index the index of the item to return
    */
    get(index: number): Route53RecordWeightedRoutingPolicyOutputReference;
}
/**
...
export declare class Route53Record extends cdktf.TerraformResource {
    ...
    */
    ...
    get zoneIdInput(): string | undefined;
    private _alias;
    get alias(): Route53RecordAliasList;
    putAlias(value: Route53RecordAlias[] | cdktf.IResolvable): void;
    resetAlias(): void;
    get aliasInput(): cdktf.IResolvable | Route53RecordAlias[] | undefined;
    private _failoverRoutingPolicy;
    get failoverRoutingPolicy(): Route53RecordFailoverRoutingPolicyList;
    putFailoverRoutingPolicy(value: Route53RecordFailoverRoutingPolicy[] | cdktf.IResolvable): void;
    ...
    get geolocationRoutingPolicy(): Route53RecordGeolocationRoutingPolicyList;
    putGeolocationRoutingPolicy(value: Route53RecordGeolocationRoutingPolicy[] | cdktf.IResolvable): void;
    ...
    get latencyRoutingPolicy(): Route53RecordLatencyRoutingPolicyList;
    putLatencyRoutingPolicy(value: Route53RecordLatencyRoutingPolicy[] | cdktf.IResolvable): void;
    ...
    get weightedRoutingPolicy(): Route53RecordWeightedRoutingPolicyList;
    putWeightedRoutingPolicy(value: Route53RecordWeightedRoutingPolicy[] | cdktf.IResolvable): void;
