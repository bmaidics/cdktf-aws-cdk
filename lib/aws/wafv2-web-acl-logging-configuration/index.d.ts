...
export declare function wafv2WebAclLoggingConfigurationRedactedFieldsAllQueryArgumentsToHclTerraform(struct?: Wafv2WebAclLoggingConfigurationRedactedFieldsAllQueryArgumentsOutputReference | Wafv2WebAclLoggingConfigurationRedactedFieldsAllQueryArguments): any;
...
export declare function wafv2WebAclLoggingConfigurationRedactedFieldsBodyToHclTerraform(struct?: Wafv2WebAclLoggingConfigurationRedactedFieldsBodyOutputReference | Wafv2WebAclLoggingConfigurationRedactedFieldsBody): any;
...
export declare function wafv2WebAclLoggingConfigurationRedactedFieldsSingleQueryArgumentToHclTerraform(struct?: Wafv2WebAclLoggingConfigurationRedactedFieldsSingleQueryArgumentOutputReference | Wafv2WebAclLoggingConfigurationRedactedFieldsSingleQueryArgument): any;
...
export declare class Wafv2WebAclLoggingConfigurationRedactedFieldsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get allQueryArguments(): Wafv2WebAclLoggingConfigurationRedactedFieldsAllQueryArgumentsOutputReference;
    putAllQueryArguments(value: Wafv2WebAclLoggingConfigurationRedactedFieldsAllQueryArguments): void;
    resetAllQueryArguments(): void;
    get allQueryArgumentsInput(): Wafv2WebAclLoggingConfigurationRedactedFieldsAllQueryArguments | undefined;
    private _body;
    get body(): Wafv2WebAclLoggingConfigurationRedactedFieldsBodyOutputReference;
    putBody(value: Wafv2WebAclLoggingConfigurationRedactedFieldsBody): void;
    resetBody(): void;
    get bodyInput(): Wafv2WebAclLoggingConfigurationRedactedFieldsBody | undefined;
    private _method;
    ...
    get singleQueryArgument(): Wafv2WebAclLoggingConfigurationRedactedFieldsSingleQueryArgumentOutputReference;
    putSingleQueryArgument(value: Wafv2WebAclLoggingConfigurationRedactedFieldsSingleQueryArgument): void;
    resetSingleQueryArgument(): void;
    get singleQueryArgumentInput(): Wafv2WebAclLoggingConfigurationRedactedFieldsSingleQueryArgument | undefined;
    private _uriPath;
