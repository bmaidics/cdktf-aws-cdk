...
export { isRegistryModule, TerraformModuleConstraint, TerraformProviderConstraint, isLocalModule, } from "@cdktf/commons";
...
export declare function generateProviderBindingsFromSchema(targetPath: string, schemaJSON: ProviderSchema, options?: srcmak.Options): Promise<void>;
