...
Transform[_a] = { fqn: "projen.javascript.Transform", version: "0.87.0" };
class WatchPlugin {
    constructor(name, options) {
        this.name = name;
        this.options = options;
...
WatchPlugin[_b] = { fqn: "projen.javascript.WatchPlugin", version: "0.87.0" };
var UpdateSnapshot;
...
JestReporter[_c] = { fqn: "projen.javascript.JestReporter", version: "0.87.0" };
/**
...
Jest[_d] = { fqn: "projen.javascript.Jest", version: "0.87.0" };
